...
say('## 1. Unit suites');
let unitsGreen = true;
for (const suite of ['op_smoke_test.mjs', 'trace_repair_test.mjs', 'geom_core_test.mjs', 'persistence_test.mjs', 'design_space_test.mjs', 'capability_test.mjs', 'studio_ask_test.mjs']) {
